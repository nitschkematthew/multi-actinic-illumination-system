...
## This is a make-file for the analysis of spectral data using the R package Pavo "http://rafaelmaia.net/pavo/". 
## Below are scripts for the exploration and description of LED spectral quality (peak shape, intensity).
